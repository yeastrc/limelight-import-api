 ...
 *         &lt;element ref="{}peptide_open_modification" minOccurs="0"/>
...
public class ReportedPeptide {
    ...
    @XmlElement(name = "peptide_open_modification")
    protected PeptideOpenModification peptideOpenModification;
    ...
    /**
     * If an open mod mass is associated with this identified peptide, use this element to specify. Important: If the same peptide sequence is identified but with different open modifications (e.g. PEPTIDE +20 and PEPTIDE +169), these should be entered as separate reported peptides in Limelight XML. The open mod mass should also be part of the unique reported peptide string (e.g. PEP[+16]TIDE+169 if the peptide was IDed with an open mod mass of 169. Also, all PSMs that identified this peptide with this open mod mass should be listed under the respective reported peptide.
     * 
     * @return
     *     possible object is
     *     {@link PeptideOpenModification }
     *     
     */
    public PeptideOpenModification getPeptideOpenModification() {
        return peptideOpenModification;
    }

    /**
     * Sets the value of the peptideOpenModification property.
     * 
     * @param value
     *     allowed object is
     *     {@link PeptideOpenModification }
     *     
     */
    public void setPeptideOpenModification(PeptideOpenModification value) {
        this.peptideOpenModification = value;
    }
