...
public class ReportedPeptide {
    ...
    /**
     * The peptide-level modifications for this reported peptide. E.g., if phosphorylation was searched for, store those modifcations here. Do not list static / fixed modifications (e.g. 57 on C)
     * 
     * @return
     *     possible object is
