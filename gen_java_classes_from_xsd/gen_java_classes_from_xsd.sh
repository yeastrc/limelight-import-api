...
# windows command:
"C:\Program Files\Java\jdk1.8.0_102\bin\xjc.exe" -d ..\src_java_jaxb_classes_from_xsd -p org.yeastrc.limelight.limelight_import.api.xml_dto ..\xsd/limelight-xml-v0.11.0.xsd
